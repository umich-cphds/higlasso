...
// higlasso_internal
Rcpp::List higlasso_internal(arma::vec Y, arma::field <arma::mat> Xm, arma::mat Z, arma::field <arma::vec> beta, arma::field                                  <arma::vec> eta_init, double l1, double l2, double sigma, int maxit, int halfmax, double delta);
RcppExport SEXP _higlasso_higlasso_internal(SEXP YSEXP, SEXP XmSEXP, SEXP ZSEXP, SEXP betaSEXP, SEXP eta_initSEXP, SEXP l1SEXP, SEXP l2SEXP, SEXP sigmaSEXP, SEXP maxitSEXP, SEXP halfmaxSEXP, SEXP deltaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(higlasso_internal(Y, Xm, Z, beta, eta_init, l1, l2, sigma, maxit, halfmax, delta));
    return rcpp_result_gen;
END_RCPP
}
